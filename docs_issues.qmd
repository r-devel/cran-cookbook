...
This should not discourage from writing extensive test and documentation with high code coverage but rather encourage sensible testing. Avoid vignettes or tests with many iterations, run them on small toy data or provide precomputed results. 
