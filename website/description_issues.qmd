...
Same goes for MIT-License files with wrongly specified copyright holders. Surprisingly often, package authors write “[packagename] authors” (which is fine) but still list an old/outdated packagename.
