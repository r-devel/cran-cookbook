...
The automatic tests will only produce a NOTE when more than 2 cores are used in examples, vignettes, tests or the installation. The possibility to set the amount of cores should be given in any function and the default is ideally set to less than 2 cores.
