...
You are writing by default or in your examples, vignettes or tests in the user's home filespace, including the package directory and `getwd()`.
...
::: {.callout-note title="Comment of CRAN maintainers" appearance="simple" icon=false collapse=true}
...
Packages can write per default to `tempdir()` or don't add a default path at all, as long as the default is not the user's home filespace.  
