...
# Example wrappers: \\dontrun{} and \\donttest{}

## Problem 

Your examples are wrapped incorrectly. 

## Solution

Wrap your examples according to this list:
...
* **\\dontrun{}:**
  + Unexecutable examples (e.g. API calls where a password is needed)
  + Examples which require additional software
  
All other examples should either be not wrapped or marked differently (see the [list] below for more detailed wrappers).
