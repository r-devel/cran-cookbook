...
Similarly, changes in the 'roxygen2'-section of .R-files will not transfer to the .Rd-files without a re-rendering. 

::: {.callout-tip}
To avoid this mistake, make sure to **always** call `roxygenize()` before submitting your package.
:::

If you want to know more on how to use 'roxygen2' to crerate your manuals, take a look at their [website](https://roxygen2.r-lib.org/index.html).
